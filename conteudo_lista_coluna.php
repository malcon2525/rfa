            ...
            <?
              ...
              if ($destaquePPDB) {
                foreach ($destaquePPDB as $destaquePP) {
				  ...
				  $chamada = $destaquePP['chamada'];
				  $codigo = $destaquePP['codigo_produto'];
				  $conteudo = $destaquePP['conteudo'];
                  ...
                  echo "
					...
					<div class=\"col-sm-4\">
						<article class=\"news-post\">
                            ...
                            <div class=\"pmio\"><span>PRÊMIO:</span>$conteudo</div>
                            <p class=\"gdra\"><span>GANHADORA DE:</span>$chamada</p>
                            <time datetime=\"$data\"></time>
                            <p class=\"cdgo\"><span>CÓDIGO: </span>$codigo</p>
