    ...
    <form action="index.php?pag=conteudo-cad" method="post" enctype="multipart/form-data">
			...
			<div class="form-row">
			    <div class="form-group col-md-10">
			      <label for="titulo">Nome da Revendedora: </label>
			...
			<div class="form-row">	
				<div class="form-group col-md-10">
					<label for="chamada">Data da Premiação:</label><!-- <span id="faltaCH" class="caracteres-restantes"> 150</span> -->  <!-- <span class="caracteres-restantes">caracteres restantes</span> -->
					<textarea class="form-control" id="chamada" name="chamada" rows="1" maxlength="40" onkeyup=""><?=$chamada?></textarea>
				</div> 
				<!-- <div class="form-group col-md-2 ">	
			...
			<div class="form-row">	
				<div class="form-group col-md-10">	
					    <label for="conteudo">Descrição do Premio:</label>
               <input class="form-control" type="text" name="conteudo" id="conteudo" value="<?=$conteudo?>" required="" >
			        </div>			
			</div>	
		  ...
		  <div class="form-row">	
               ...
               <input class="form-control" type="text" name="codigo_produto" id="codigo_produto" value="<?=$codigo_produto?>" required="" >
			        </div>			
			</div>			
        ...
        ?>
				...
				<div class="form-group col-md-6">
			     <label for="titulo"><!-- Área do Conteudo na PP --> </label>
     	          <input class="form-control" type="<?=$tipo_campo?>" name="conteudo_localizacao_id" id="conteudo_localizacao_id" value="7" required="" >
			  </div>
