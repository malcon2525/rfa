...
if ($nome_foto != "") {
	...
	if (!$testeType){
		$msg_erro = "Erro ao gravar a imagem: $nome_foto - Formato da foto invalido<br>[formato=$formato]";
	}

	if ($tamanho > 4000000){
		$msg_erro = "Erro ao gravar a imagem: $nome_foto - Excedeu o limite de 4 MB<br>";
	}
	...
	if ($msg_erro == "") {
		...
		if ($id) {
			...
			$sql = "INSERT INTO $tabela ($campo, galeria_id) VALUES ('".$nome_foto."', '".$galeria_id."') ";
			$cria = mysql_query($sql);
			echo mysql_error();
		}
