...
<p></p>
    ...
    <form action="index.php?pag=conteudo-cad" method="post" enctype="multipart/form-data">
			...
			<div class="form-row">	
				<div class="form-group col-md-10">
					<label for="chamada">Depoimento:</label><!-- <span id="faltaCH" class="caracteres-restantes"> 150</span> -->  <!-- <span class="caracteres-restantes">caracteres restantes</span> -->
					<textarea class="form-control" id="conteudo" name="conteudo" rows="4" maxlength="400" onkeyup=""><?=$conteudo?></textarea>
				</div> 
				<!-- <div class="form-group col-md-2 ">	
        ...
        ?>
				...
				<div class="form-group col-md-6">
			     <label for="titulo"><!-- Área do Conteudo na PP --> </label>
     	          <input class="form-control" type="<?=$tipo_campo?>" name="conteudo_localizacao_id" id="conteudo_localizacao_id" value="8" required="" >
			  </div>
