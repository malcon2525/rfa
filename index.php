    ...
    if ($urlNavegacao[0] == 'ct' || $urlNavegacao[0] == 'pd') {
        ...
        if ($conteudoDB) {
          foreach ($conteudoDB as $conteudoH) {
			...
			$site_name = SITENAME;
			$title = "BLOG | ".SITENAME;
			$description = "Blog da Ralifla - confira as últimas novidades aqui no nosso site.";
			$url_site = BASE."/$urlNavegacao[0]";
...
<div class="page text-center">
    ...
    <div class="old-ie"
        ...
        <a href="http://windows.microsoft.com/en-US/internet-explorer/..">
            <img src="<?=BASE?>/images/ie8-panel/warning_bar_0000_us.jpg" height="42" width="820"
